      ...
      <div className='top-container'>
        <div className='words mid'>
          ...
          <p>An application to find a rock climbing gym. Users are able to
            ...
            user authentication with JSON web tokens. <a href="https://earnest-profiterole-786338.netlify.app/gyms">Find a place to Climb!</a> </p>
        </div>
      ...
      <div className='top-container'>
        <div className='words mid'>
          ...
          <p>Users are able to find a description of a selected movie.
            ...
            this project. <a href=" https://7kmovies.netlify.app/">Explore a Movie!</a></p>
        </div>
